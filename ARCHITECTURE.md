...
Baseline 2026-07-27: **2238 tests / 175 files**, all four gates green on `feat/p157-seed-depth-rng` @ 77ee49f + edits (working tree; jsdom — see P-019). <!-- refresh: scripts/update-baseline.sh -->
