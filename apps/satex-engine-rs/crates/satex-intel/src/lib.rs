//! Intelligence: brain SGD, calibration (downgrade-only), pattern-learner, tactics, autonomous-trader (paper-only wall), self-eval PSR/DSR, LLM advisory wall (Phase 5).
//!
