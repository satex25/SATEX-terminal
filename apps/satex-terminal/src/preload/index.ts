...
import type {
  ...
  LlmStatus, LlmConfigSetRequest, AiDecision, CalibrationSnapshot, SelfEvalStatus, SelfEvalReport,
  WireSnapshot,
...
const satexApi = {
  ...
  getSelfEvalReport: ()                            => ipcRenderer.invoke(IPC.SELF_EVAL_REPORT_GET) as Promise<SelfEvalReport | null>,
