...
### P-094 · Six main-process services carry zero test coverage; one (`live-mode.ts`) is the live-capital arming interlock itself — SHIPPED (2026-07-22; all coverage complete — four safe autonomous picks + the two human-gated interlocks; live-mode+tactics on branch/PR held for operator sign-off)
