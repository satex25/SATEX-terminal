...
### P-155 · **The AI decision path is not replay-deterministic** — unseeded `Math.random()` in the depth ladder reaches ~25 % of every confidence score, blocking Oracle L1 decision parity — OPEN (operator ruling; found by the RS-1.3 driver, 2026-07-25)
...
- **Status:** OPEN. Blocks: RS-1.4 parity on the decision stream; full closure of plan risk R3. Does not block: RS-1.4 on state/gates, RS-1.7 mutation testing.
