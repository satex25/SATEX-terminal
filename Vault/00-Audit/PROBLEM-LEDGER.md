...
- **Status:** SHIPPED (unstaged, master @ 4788d9c working tree). Flip VERIFIED after operator review + commit + CI green.

### P-111 · Simulator 24/7 emission + LIVE→PAPER clean-slate restart — the depth-feed pile, landed with operator sign-off — SHIPPED (branch `feat/p111-sim-24-7-live-paper-restart`, PR pending merge)
