...
### P-153 · RS-UP-1 / RS-1.3 — golden-capture driver **CLAIMED**; slice 1 shipped: the golden record contract (canonical serialisation · id normaliser · stream hash) with 30 tests — IN-PROGRESS (2026-07-25, branch `feat/rs-1.3-golden-contract`)
